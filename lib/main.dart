...
//import 'package:image_widget/home.dart';
...
class MyApp extends StatelessWidget {
  static final String title = 'Image Widget';
...
class _HomePageState extends State<HomePage> {
        ...
        bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                  icon: Icon(Icons.network_wifi), label: 'Network'),
              BottomNavigationBarItem(
                  icon: Icon(Icons.web_asset_rounded), label: 'Asset'),
              BottomNavigationBarItem(
                  icon: Icon(Icons.file_copy_rounded), label: 'File'),
              BottomNavigationBarItem(
                  icon: Icon(Icons.file_copy_outlined), label: 'Memory'),
            ],
  ...
  Widget loadFileImage() {
    return Center(
        child: Image.file(
      File('/storage/emulated/0/Download/beauty.jpg'),
      width: 400,
      height: 400,
    ));
  }
